...
# MODEL_PATH="${MODEL_PATH:-./saves/0728_7b_toolcall_3more_ocr_code}"
MODEL_PATH="${MODEL_PATH:-./saves/0715_32b_toolcall_3more_ocr_code}"
...
for dataset in "${datasets[@]}"; do
    python src/infer_w_tools_webwatcher.py --model_name_or_path ${MODEL_PATH} --data ${dataset} --overwrite 0
done
