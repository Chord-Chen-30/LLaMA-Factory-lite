MODEL_PATH="./saves/qwen3_vl_30b_a8b_1203_cleaned/checkpoint-50"
...
for dataset in "${datasets[@]}"; do
    python src/infer_w_tools.py --model_name_or_path ${MODEL_PATH} --data ${dataset} --date 2025-12-04
done
...
# score
cd ./agent_infer/src;
python qwen_max_score.py --data_path ../result/2025-12-04/checkpoint-50/simplevqa_300_w_tools.jsonl