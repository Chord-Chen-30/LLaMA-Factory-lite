...
MODEL_PATHS=(
    ...
    "./saves/qwen3_vl_30b_a8b_1203_cleaned/checkpoint-50"
    "./saves/qwen3_vl_30b_a8b_1203_cleaned/checkpoint-100"
    "./saves/qwen3_vl_30b_a8b_1203_cleaned/checkpoint-200"
    "./saves/qwen3_vl_30b_a8b_1203_cleaned/checkpoint-350" # Lowest eval_loss
    "./saves/qwen3_vl_30b_a8b_1203_cleaned/checkpoint-900" # Lowest train_loss
)
...
for dataset in "${datasets[@]}"; do
    ...
    python src/qwen_max_score.py --data_path ./result/2025-12-04/${model_bn}/${data_bn}_w_tools.jsonl --overwrite 0
done
